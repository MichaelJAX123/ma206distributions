...
🚧 In website pkgdown version of this, why is pkgdown failing to deliver visuals that we create in the README.rmd?  Getting this error: Warning message:
*Missing images in 'README.md': 'README_files/figure-gfm/unnamed-chunk-3-1.png', pkgdown can only use images in 'man/figures' and 'vignettes'* Should be fixed, but not working for me: https://github.com/r-lib/pkgdown/pull/1977  😭 😭 😭
...
🤔  🚧 Would the single_trial_prob columns be more appropriately stored as meta data?  How would be best to do that? Source code [here](https://github.com/EvaMaeRey/ma206distributions/blob/main/R/dbinom_df.R) 
